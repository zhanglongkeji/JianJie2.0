package com.zlkj.jianjie.custom;
...
public class DropDownMenu extends LinearLayout{
    ...
    private void init(Context mContext){
        ...
        mShowCheck=true;
        mShowDivider=true;
        mCheckIcon=R.mipmap.ico_make;
        mUpArrow=R.mipmap.location_down;
        mDownArrow=R.mipmap.location_down;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDrawable) {
            ...
            for (int i = 0; i < mMenuCount; i++) {
                ...
                TextView mytx= (TextView) v.findViewById(R.id.meny_item_texg);
                ...
                if(i==3){
                    mytx.setVisibility(INVISIBLE);
                }else{
                    mytx.setVisibility(VISIBLE);
                }
